"""
Management command to test all Grantify workflows end-to-end.
...
class TestResult:
    ...
    def report(self):
        ...
        print('\n')
        print('=' * 78)
        print('  GRANTIFY WORKFLOW TEST REPORT')
        print('=' * 78)
...
class Command(BaseCommand):
    help = 'Run end-to-end workflow tests for Grantify using Django test Client'
